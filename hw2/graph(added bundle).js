...
var c_point = {x:width/2, y:height/2} //bundle---control point = parent nodes = cneter of circle
...
function graph_update(duration) {
  ...
  if(circular_layout_checked){
    var link = svg.append("g").selectAll(".link")
    link.data(bundle(graph.links)) // creates the links
    .enter().append("path")
    .attr("d", line)
  }
